...
{ 
    public class IndexController : OKHOSTING.UI.Controller
    {
        ...
        public override void Start()
        {
			...
			imagen.LoadFromUrl (new Uri ("http://app-udg.okhosting.com/ICONOS-PROG/icon2--01.png"));
			imagen.Width = 50;
			imagen.Height = 20;
			panel.Add(imagen, RelativePanelHorizontalContraint.RightWith, RelativePanelVerticalContraint.AboveOf, lblLabel);
			...
			imagen2.LoadFromUrl (new Uri ("http://app-udg.okhosting.com/ICONOS-PROG/icon-13.png"));
			imagen2.Width = 40;
			imagen2.Height = 15;
			...
			imagen3.LoadFromUrl (new Uri ("http://app-udg.okhosting.com/ICONOS-PROG/icon-14.png"));
			imagen3.Width = 40;
			imagen3.Height = 15;
